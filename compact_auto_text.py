...
def send():
    ...
    sentences = [
        [
            f"Alright, the host has set us 6 rules in her Dojo:",
            "So, the host has set us some rules:",
            f"Well, the host has set 6 rules here:",
            "Some quick rules for better and more enjoyable gameplay:",
            f"Follow those 6 rules or get Banned:"
        ],
    ...
    sentences_to_write = []
    for el in sentences:
        sentences_to_write.append(random.choice(el))
